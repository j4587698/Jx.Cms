...
{
    [Description("文章ID")] public int ArticleId { get; set; }

    [Navigate(nameof(ArticleId))] public virtual ArticleEntity ArticleEntity { get; set; }

    [Description("作者名")] public string AuthorName { get; set; }

    [Description("作者Email")] public string AuthorEmail { get; set; }

    [Description("作者地址")] public string AuthorUrl { get; set; }
    ...
    [Description("内容")] [MaxLength(2048)] public string Content { get; set; }

    [Description("评论状态")] public CommentStatusEnum Status { get; set; }
}