...
public class AdminUserEntity : BaseEntity<AdminUserEntity, Guid>
{
    ...
    [Description("邮箱")] public string Email { get; set; }

    [Description("显示名")] public string NickName { get; set; }

    [Description("用户主页")] public string HomePage { get; set; }

    [Description("用户类型")] public string Type { get; set; }
}